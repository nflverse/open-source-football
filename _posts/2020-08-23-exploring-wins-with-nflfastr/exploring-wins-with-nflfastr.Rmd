    ...
    p1 <- r_squareds %>% 
      ...
      theme(
        ...
        axis.text = element_text(size = 10,
                                 color = "black"))
```
```{r echo = FALSE, warning = FALSE, message=FALSE, dpi=200, preview = TRUE}
p1
```
...
p7
```
On the other end of the spectrum the Patriots have only underperformed by more than half a game two times.
