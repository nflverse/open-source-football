...
Lets say I wanted to partition the data by both season and play type. We can do this by converting our feather file to a dataset. We should choose ways to split the data that make the most 
