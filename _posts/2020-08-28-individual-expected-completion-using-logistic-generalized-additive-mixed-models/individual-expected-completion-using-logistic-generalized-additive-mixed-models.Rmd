...
```{r, Plot 1,layout="l-page", fig.height=5.5, preview=TRUE}
...
plot %>% filter(
  ...
  labs(y="iProbability of Completion",
       ...
       subtitle = 'How each QB increases probability completion, controlling for situation | Generalized Additive Mixed Model (GAMM)',
...
```{r, Plot 1,layout="l-page", fig.height=6, preview=TRUE}
