...
interactive_weekly_qbr <- function(year, QB, all_qbr_file) {
  ...
  chart %>%
    ...
    geom_hline(yintercept = quantiles, color = "black", linetype = "dashed", alpha = 0.7) +
    geom_hline(yintercept = quantile(all_qbr_file$qbr_total, 0.50), color = "black", linetype = "solid", alpha = 0.7) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.10), label = "10th Percentile", size = 2) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.25), label = "25th Percentile", size = 2) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.50), label = "50th Percentile", size = 2) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.75), label = "75th Percentile", size = 2) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.90), label = "90th Percentile", size = 2) +
    geom_text(x = -0.5, y = 2 + quantile(all_qbr_file$qbr_total, 0.98), label = "98th Percentile", size = 2) +
...
```{r}
library(plotly)
ggplotly(interactive_weekly_qbr(2007, "Tom Brady", all_qbr), tooltip = "text") %>% 
  plotly::layout()
```
