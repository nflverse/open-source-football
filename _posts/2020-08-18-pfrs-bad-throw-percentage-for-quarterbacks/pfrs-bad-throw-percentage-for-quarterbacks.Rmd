...
PFR provides it's data on static html website which makes it easy to scrape them.
...
the plot: #fig.width=10, fig.asp=1/1.2
...
chart_data %>% 
  ...
  #       legend.position = "top",
  #       legend.title = element_text(size = 8, vjust = 0.5, face = 'bold')
  #       # aspect.ratio = 1/1.618
  #       ) +
  NULL
