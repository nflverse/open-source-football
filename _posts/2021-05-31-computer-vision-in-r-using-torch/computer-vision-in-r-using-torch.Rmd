...
for (fold in 1:length(folds)) {
  ...
  for (epoch in 1:epochs) {
    ...
    for (b in enumerate(.train_dl)) {
      ...
      # augment first
      b_augmented <- augment_data(b$x, c(4, 6, 9, 11, 13), c(2))
