...
ggplot(data = prem_epa_df, aes(x = pass_epa_prem, y = pass_freq)) +
  ...
  labs(title = 'Dropback Premium vs Droback Frequency',
       subtitle = 'Early Downs with Win Probability Between 20% and 80% Outside of Last\nTwo Minutes of The Half',
       y = 'Dropback Freq',
...
ggplot(data = prem_epa_df, aes(x = pass_epa_prem, y = pass_freq)) +
  ...
  scale_y_continuous(labels = percent_format(accuracy = 1), breaks = seq(0,1,.05), limits = c(.45,.7), expand = expansion(mult = c(0.03,0.03))) +
  labs(title = 'Dropback Premium vs Droback Frequency',
