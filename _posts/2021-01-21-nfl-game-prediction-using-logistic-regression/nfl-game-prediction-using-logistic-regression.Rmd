...
description: |
  Use Python and scikit-learn to build a NFL game outcomes and build a pre-game win probability model.
author:
  - name: Ben Dominguez
...
```
```{python feature_importance_plot}
fig, ax = plt.subplots()
