---
title: "nflfastR EP, WP, CP and xYAC models"
description: |
  A description of the nflfastR Expected Points (EP), Win Probability (WP), Completion Probability (CP) and Expected Yards after Catch (xYAC) models.
author:
  - name: Ben Baldwin
