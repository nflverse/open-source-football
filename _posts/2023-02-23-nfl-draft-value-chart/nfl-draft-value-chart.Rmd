...
**Updated on February 27, 2023**: (a) added more picks to the table at the bottom so it now displays picks 1-256, (b) added on-field value to table at the bottom, and (c) re-scaled surplus value so it's 0-to-100 (thank you to Luckym4n\_ [for the suggestion](https://twitter.com/Luckym4n_/status/1629595953261838336))/
