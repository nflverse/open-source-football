...
#   )
# })
# data.table::fwrite(pbp, "Darkweb/pbp_2010-2019.csv")

pbp <- data.table::fread("Darkweb/pbp_2010-2019.csv")
```
...
Here we visualize how our nnet trained over our epochs. We define epochs to 61 here since we had some early stopping.

```{r}
library(ggplot2)
history$params$epochs <- 61
